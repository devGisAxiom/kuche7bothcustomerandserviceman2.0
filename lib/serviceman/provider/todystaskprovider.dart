...
// import 'package:design/serviceman/api/todaystaskapi.dart';
// import 'package:design/serviceman/model/activeservicemodel.dart';
import 'package:flutter/material.dart';
import 'package:flutter_application_1/serviceman/api/todaystaskapi.dart';
import 'package:flutter_application_1/serviceman/model/activeservicemodel.dart';


class ActiveServiceProviders with ChangeNotifier {
  final TodayTaskApi _apiService = TodayTaskApi();
